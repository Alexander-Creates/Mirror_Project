...
static const char *object_names[] = { "main", "device_battery_value", "euc_battery_value", "pwm_value", "speed_value", "pwm_arc", "speed_arc", "euc_connected_status" };
